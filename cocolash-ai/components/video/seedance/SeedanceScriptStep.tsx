...
export function SeedanceScriptStep({ onScriptSelected }: SeedanceScriptStepProps) {
  ...
  const handleUseScript = () => {
    ...
    onScriptSelected(script, { campaignType, tone, duration }, finalText);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Button
        ...
        className="w-full gap-2 bg-coco-brown py-5 text-sm font-semibold text-white shadow-md transition-all hover:bg-coco-brown-light disabled:opacity-50"
        size="lg"
      >
        {isGenerating ? (
